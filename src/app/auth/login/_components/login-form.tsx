    ...
    <>
      <div className="p-10 relative z-20">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          {/* Submit Button */}
          <CustomButton loading={isLoading} type={"submit"} title={"Create an Account"} styles="flex justify-center items-center w-full mt-5 py-2.5 text-center border border-[#bbb] hover:bg-black hover:text-white transition duration-300 mb-5"/>
